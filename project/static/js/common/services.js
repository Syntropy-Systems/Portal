...
app.factory("CommonRead", function($http, CommonRequests) {
    return {
        ...
        read_order_types: function(scope,params){
            return CommonRequests.read_common_records(scope, "order_types", "/common_requests/read_order_types/",params);
        },

        read_clients: function(scope,params){
            return CommonRequests.read_common_records(scope, "clients", "/common_requests/read_clients/",params);
        },

        read_cdas: function(scope,params){
            return CommonRequests.read_common_records(scope, "cdas", "/common_requests/read_cdas/",params);
        }
    }
})
